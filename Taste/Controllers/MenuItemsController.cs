...
using Taste.Data;
using Taste.Models;
using Taste.Models.MenuItemViewModels;
using Taste.Utility;
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    if(files[0].Length>0 && files[0] != null)
                    {
                        ...
                        var extension_Old = menuItemFromDb.Image.Substring(files[0].FileName.LastIndexOf("."), menuItemFromDb.Image.Length - menuItemFromDb.Image.LastIndexOf("."));
